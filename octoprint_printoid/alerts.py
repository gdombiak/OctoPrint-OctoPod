...
class Alerts:
	...
	def send_alert_code(self, fcm_token, url, printer_id, printer_name, event_code, image=None,
						event_param=None):
		self._logger.info("//// Send alert to Printoid: '%s' with value %s (%s)" % (
			event_code, event_param, printer_name))
